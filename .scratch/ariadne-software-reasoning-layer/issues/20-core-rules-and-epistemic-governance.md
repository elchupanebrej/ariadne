# 20 — Core rules and epistemic governance (00-core, evidence, invalidation, roles, depth-modes, agent-rules)

**What to build:** Governance rule files defining the 10-rung evidence ladder, 8 epistemic role contracts, 3 depth modes (Fast, Standard, Deep), and 12 Developer Agent Invariant Rules in ASD-STE100 / RFC 2119 format.
